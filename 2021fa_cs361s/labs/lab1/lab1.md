...
i.e, the socket system calls is being performed with the correct arguments. It is alright if the other parts of the exploit don't work. Enclose a screenshot of this output in `report.pdf` and upload it along with the other files.
